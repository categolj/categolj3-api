...
public class BlogApplication {
    ...
    String getEntry(Model model, @Value("#{request.requestURL}") StringBuffer requestUrl, @PathVariable("entryId") Long entryId) {
        Entry entry = restTemplate.exchange(requestUrl.toString().replace("/entries", "/api/entries")
                , HttpMethod.GET, HttpEntity.EMPTY, Entry.class).getBody();
